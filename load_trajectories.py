...
true_ilqr = pickle.load(open("Trajectories/xs_ilqr_no_mpc.pkl", "rb"))
model_ilqr = pickle.load(open("Trajectories/xs_predicted_ilqr_no_mpc.pkl", "rb"))
ilqr_actions = pickle.load(open("Trajectories/us_ilqr_no_mpc.pkl", "rb"))

true_mpc = pickle.load(open("Trajectories/xs_ilqr_mp.pkl", "rb"))
model_mpc = pickle.load(open("Trajectories/xs_predicted_ilqr_mp.pkl", "rb"))
mpc_actions = pickle.load(open("Trajectories/us_ilqr_mp.pkl", "rb"))

true_ddp_ilqr = pickle.load(open("Trajectories/xs_ddp_no_mpc.pkl", "rb"))
model_ddp_ilqr = pickle.load(open("Trajectories/xs_predicted_ddp_no_mpc.pkl", "rb"))
ddp_ilqr_actions = pickle.load(open("Trajectories/us_ddp_no_mpc.pkl", "rb"))

true_ddp_mpc = pickle.load(open("Trajectories/xs_ddp_mp.pkl", "rb"))
model_ddp_mpc = pickle.load(open("Trajectories/xs_predicted_ddp_mp.pkl", "rb"))
